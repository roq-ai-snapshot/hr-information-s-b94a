  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience simplicity and efficiency with HR Information System - your one-stop solution for managing employee data, vacations, and payroll."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience simplicity and efficiency with HR Information System - your one-stop solution for managing employee data, vacations, and payroll.`}
            </Text>
            <Box
